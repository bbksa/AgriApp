...
class Sprayers extends StatefulWidget {
  const Sprayers({ Key? key }) : super(key: key);

  @override
  _SprayersState createState() => _SprayersState();
}

class _SprayersState extends State<Sprayers> {
  @override
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const SizedBox(
          height: 25.0, child: Text("Sprayers")),
          actions: <Widget>[
          Padding(

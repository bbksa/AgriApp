...
class Herbicide extends StatefulWidget {
  const Herbicide({ Key? key }) : super(key: key);

  @override
  _HerbicideState createState() => _HerbicideState();
}

class _HerbicideState extends State<Herbicide> {
  @override
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const SizedBox(
          height: 25.0, child: Text("Herbicide")),
          actions: <Widget>[
          Padding(

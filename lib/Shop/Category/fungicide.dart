...
class Fungicide extends StatefulWidget {
  const Fungicide({ Key? key }) : super(key: key);

  @override
  _FungicideState createState() => _FungicideState();
}

class _FungicideState extends State<Fungicide> {
  @override
